...
function Nav() {
  ...
  useEffect(() => {
    let handler = (e: any) => {
      ...
      if (!respNav?.current!.contains(e.target as any)) {
        setrespNavHidden(false);
      }
    };
    ...
    <div>
      ...
      <div className={style.navContainer}>
        <div className={style.greenNav}>
          <nav
            className={`${style.nav} flex lg:flex-cols-4 flex-cols-2 justify-between items-center`}
          >
            <div>
              <Image
            ...
            <div
              className={`${style.navSearch} lg:grid col-span-2 grid-cols-3 justify-items-end hidden`}
            >
              <input
                type="text"
                placeholder="Search Store"
                className={`${style.searchInput} grid col-span-2`}
              />
              <button>
            ...
            <div
              ref={menuRef}
              className={`${style.profile} flex flex-cols-3 items-center justify-between`}
            >
              <button onClick={showRespNav} className="lg:hidden flex">
                <span>
                  <IoIosMenu className={`${style.respNav}`} />
                </span>
              </button>
              <button>
                <AiOutlineUser
                  className={`${style.profIcon}`}
                  onClick={userClick}
                />
              </button>
              <button className={`${style.icon} lg:grid hidden`}>
                <Link href="/wishlist">
                  <IoMdHeartEmpty
                    className={`${style.profIcon} ${style.wishIcon}`}
                  />
                </Link>
              ...
              <div className={style.userLog}>
                <ul>
                  <li>
                    ...
                    <Link href="" className={style.logLink}>
                      REGISTER
                    </Link>
                  </li>
                  <li>
          ...
          <div
            className={`${style.hiddenSearch} lg:hidden flex justify-between`}
          >
          ...
          {cartSummery && (
            <div className={style.cartSummery}>
              ...
              <div className={style.details}>
                ...
                <div>
                  <Link href="" className={style.productName}>
                    Product Name
                  </Link>
              ...
              <div className={style.totalPrice}>
                ...
                <div className={style.cartBtn}>
                  <button className={style.goToCartBtn}>
                    <PiShoppingCart className={style.cartIcon} />
                    GO TO CART
                  </button>
