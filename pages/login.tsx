...
const Login: NextPage = () => {
  ...
  return (
    ...
    <div className={`${style.contain} lg:w-5/6 xl:w-2/3 w-full m-auto`}>
                ...
                <div className={`${style.mainContainer} grid lg:grid-cols-2 grid-cols-1 gap-5`}>
                    <div  className={`${style.loginContainer}`}>
                       <form onSubmit={handleSubmit} method="POST">
                        <h1 className={style.border}>RETURNING CUSTOMER</h1>
                        <div>   
                            {errors.email && touched.email && <span className={`${style.errors} flex justify-end mr-10`}>{errors.email}</span>} 
                            <div className={`${style.borderInput} flex  justify-between items-center`}>  
                                <label>Email</label>
                                <input
                            ...
                            {errors.password && touched.password && <span className={`${style.errors} flex justify-end mr-10`}>{errors.password}</span>}
                            <div className={`${style.borderInput} flex  justify-between items-center`}>
                        ...
                        <div className={`${style.borderInput } flex  justify-between`}>
                            <div>
                                <input type="checkbox" name="remember" value="true" className={style.check}/>
                                <label>Remember me?</label>
                            </div>
                            <Link href='' className={style.forgetPass}>Forgot password?</Link>
                        </div>
                        <div className={style.b}>
                            <button 
                            type="submit" className={style.Btn}>LOG IN</button>
                        </div>
                        </form> 
                    </div>  
                ...
                <div className={style.aboutRegister}>
                    ...
                    <p className={style.aboutDesc}>Put your login / registration information here. You can edit this in the admin site.</p>
                </div> 
   </div>
  );
};
